<template>
    ...
    <div>  <!-- v-if="initializeTable">  -->
        ...
        <b-col :cols="this.appDisplayStore.views.attrs.table.collsSnippets">
            <div v-if="appDisplayStore.views.viewSelection == 'read' && userContentStore.documentsIndex.documents.length > 0">
...
//import FlipBook from '@/components/support/FlipBook.vue'
